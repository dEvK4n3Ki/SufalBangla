...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel" <?php if($this->session->userdata('language') == "arabic"){ echo 'style="float:left"'; } ?>>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title"> <?php echo $this->lang->line("Products");?>
            ...
            <td><?php if($product->product_image!=""){ ?><div class="cat-img" style="width: 50px; height: 50px;">
              <img width="100%" height="100%" src="<?php echo 'http://localhost/grocery/uploads/products/'.$product->product_image; ?>" /></div> <?php } ?></td>
                                                <td>
