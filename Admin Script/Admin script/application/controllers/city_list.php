                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php foreach($socities as $socity){ ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $socity->city_id; ?></td>
                                                        <td><?php echo $socity->city_name; ?></td>
                                                        <td class="td-actions text-right"><div class="btn-group">

                                                            <?php echo anchor('admin/delete_socity/'.$socity->city_id, '<button type="button" rel="tooltip" class="btn btn-danger btn-round">
