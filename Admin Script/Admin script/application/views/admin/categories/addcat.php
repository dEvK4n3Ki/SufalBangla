                            ...
                            <div class="box box-primary">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class="">  <?php echo $this->lang->line("Arabic Categories Title :"); ?><span class="text-danger">*</span></label>
                                            <input type="text" name="arb_cat_title" class="form-control" placeholder="Categories Title"/>
                                        </div>
                                        <div class="form-group">
