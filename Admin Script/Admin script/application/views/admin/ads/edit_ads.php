                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8" style="margin-top:  20px;">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input name="ads_key" value="<?php echo $ads->ads_key; ?>" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-8" style="margin-top:  20px;">
                                                <div class="checkbox form-horizontal-checkbox">
                                                    <label>
                                                        <input type="checkbox" name="status" <?php if($ads->status==1)echo "checked";?>> STATUS
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
