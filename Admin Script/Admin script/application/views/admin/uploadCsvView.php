                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a class="pull-right" href="https://demo.gogrocer.app/uploads/tableName.csv" style="margin:  0px 10px;padding: 0px 10px;border: 1px solid;">Sample Sheet &nbsp; <i class="fa fa-thumb-tack"> </i> </a>
                                        <div class="row">
